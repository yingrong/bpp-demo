...
@ApiModel(value = "ReportIndexDataDetailPo", description = "报表指标明细表数据实体")
@TableName(value = "t_bpp_report_index_data_detail", autoResultMap = true)
public class ReportIndexDataDetailPo {
